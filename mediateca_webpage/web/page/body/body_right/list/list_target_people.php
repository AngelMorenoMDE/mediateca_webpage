            ...
            <table class="tableBody">
                <?php foreach ($listTargetPeople as $targetPeople) { ?>
                    <tr>
                        ...
                        <td style="width: 15%;">
                            <input type="submit" class="modifyBtn" value="<?php echo "Modificar"; ?>" onclick="modifyObject('targetPeople', <?php echo $targetPeople->id(); ?>);">
                        </td>                        
                        <td style="width: 15%;">
                            <input type="submit" class="deleteBtn" value="<?php echo "Borrar"; ?>" onclick="deleteObject('targetPeople', <?php echo $targetPeople->id(); ?>);">
                        </td>
                    </tr>                        
                <?php } ?>
